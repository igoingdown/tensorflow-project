...
with open(params.test_set_subject_name_dict_pickle_path_virtuoso_7, "w") as f:
	cPickle.dump(subject_name_dict, f)

with open(params.test_set_subject_without_name_yet_list_pickle_path_virtuoso_7, "w") as f:
