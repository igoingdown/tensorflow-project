...
subject_name_dict = {}
with open(params.qa_validation_path) as f:
	for line in f:
		str_list = line.split()
		# print str_list
...
with open(params.valid_set_subject_name_dict_pickle_path_virtuoso_7, "w") as f:
	cPickle.dump(subject_name_dict, f)

with open(params.valid_set_subject_without_name_yet_list_pickle_path_virtuoso_7, "w") as f:
